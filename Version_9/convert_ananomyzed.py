...
recording_path = os.path.join(os.path.dirname(__file__), "./Audio_split/1studentAudio")
Anonymized_path = os.path.join(os.path.dirname(__file__), "./Audio_split/1studentAudio_Anonymized")
issuess = []
